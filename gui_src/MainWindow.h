...
enum {
	DUMMY, THRESHOLD, CLIP, QUANTIZE, GAMMA, CONTRAST, HISTOSTRETCH, HISTOMATCH, ERRDIFFUSION,
	BLUR, SHARPEN, MEDIAN, CONVOLVE, SPECTRUM, SWAPPHASE, FILTER, RESIZE, PERSPECTIVE, TRAPEZOID
};
using namespace IP;
...
private:
	...
	QAction*		m_actionPerspective;
	QAction*		m_actionTrapezoid;
	...
	int			m_outWidth;		// output image width
	int			m_outHeight;		// output image height
